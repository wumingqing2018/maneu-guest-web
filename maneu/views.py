    ...
    if code:
        ...
        if request.GET.get('text') == "Order":
            ...
            for i in report:
                ...
                id.append(i.id)
                time.append(i.time)
                OD_AL.append(int(content['OD']['CYL']))
                OS_AL.append(int(content['OS']['AL']))
                OD_VA.append(int(content['OD']['VA']))
                OS_VA.append(int(content['OS']['VA']))
                OD_SPH.append(int(content['OD']['SPH']))
                OS_SPH.append(int(content['OS']['SPH']))
                OD_CYL.append(int(content['OD']['CYL']))
                OS_CYL.append(int(content['OS']['CYL']))
